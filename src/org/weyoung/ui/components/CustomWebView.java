...
package org.weyoung.ui.components;
...
import org.weyoung.utils.ProxySettings;
...
public class CustomWebView extends WebView {
    ...
    public void initializeOptions() {
        ...
        if (Controller
                ...
                .getPreferences()
                .getBoolean(
                        Constants.PREFERENCES_BROWSER_ENABLE_PROXY_SETTINGS,
                        false)) {
    ...
    /**
     * ͨ���� ��WebView�ϱ��ֳ���ͣonPause Perform an 'onPause' on this WebView
     * through reflexion.
     */
    ...
    /**
     * ͨ���� ��WebView�ϱ��ֳ� �ָ�onResume Perform an 'onResume' on this WebView
     * through reflexion.
     */
