...
public class BookmarksProviderWrapper {
	...
	private static final Uri INTERNAL_BOOKMARKS_URI = Uri.parse("content://" + WeyoungBookmarksContentProvider.AUTHORITY + "/" + WeyoungBookmarksContentProvider.BOOKMARKS_TABLE);
