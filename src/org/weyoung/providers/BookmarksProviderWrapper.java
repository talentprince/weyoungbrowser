 ...
 * 
 * Copyright (C) 2013 - 2011 J. Devauchelle and contributors.
 *
...
import org.weyoung.model.UrlSuggestionItemComparator;
import org.weyoung.model.adapters.UrlSuggestionCursorAdapter;
import org.weyoung.model.items.BookmarkItem;
import org.weyoung.model.items.HistoryItem;
import org.weyoung.model.items.UrlSuggestionItem;
import org.weyoung.model.items.WeaveBookmarkItem;
import org.weyoung.providers.WeaveColumns;
...
public class BookmarksProviderWrapper {
    ...
    private static final Uri INTERNAL_BOOKMARKS_URI = Uri.parse("content://"
            + WeyoungBookmarksContentProvider.AUTHORITY + "/"
            + WeyoungBookmarksContentProvider.BOOKMARKS_TABLE);
    ...
    /**
     * ��ȡ���ʵ���ǩ ��������Ŀ��С���б� Get a list of most visited bookmarks items,
     * limited in size.
     * 
     * @param contentResolver
     *            The content resolver.
    ...
    /**
     * ���������ʵ���ʷ��¼ ���ƴ�С���б� Get a list of most recent history items,
     * limited in size.
     * 
     * @param contentResolver
     *            The content resolver.
    ...
    public static BookmarkItem getStockBookmarkById(
        ...
        Cursor c = contentResolver.query(BOOKMARKS_URI,
    ...
    /**
     * ɾ��һ����ʷ��¼ Delete an history record, e.g. reset the visited count and
     * visited date if its a bookmark, or delete it if not.
     * 
     * @param contentResolver
     *            The content resolver.
     * @param id
