...
public class ApplicationUtils {
    ...
    /**
     * ��raw�м��ض�ȡ��Ϊstring��Դ Load a raw string resource.
     * 
     * @param context
     *            The current context.
     * @param resourceId
    ...
    /**
     * ��������Ķ�����ǩ��Ϊhtml��ʽ Build the html result of the most recent
     * bookmarks.
     * 
     * @param context
     *            The current context.
    ...
    /**
     * ��������Ķ�����ʷ��Ϊhtml��ʽ Build the html result of the most recent
     * history.
     * 
     * @param context
     *            The current context.
